...
function biddut_breadcrumb_func() {
    ...
    $con_main = is_404() ? is_404() : $con1;
      ...
      if (  $con_main ) {
        ...
        //subtitle
        $breadcrumb_subtitle_page = function_exists('tpmeta_field')? tpmeta_field('biddut_breadcrumb_subtitle') : '';
        $breadcrumb_subtitle_kirki = get_theme_mod( 'breadcrumb_subtitle' );

        $breadcrumb_subtitle_main = !empty($breadcrumb_subtitle_page)? $breadcrumb_subtitle_page: $breadcrumb_subtitle_kirki;
      
        
        ?>

         <!-- breadcrumb area start -->
      <div class="breadcrumb__area breadcrumb__overlay breadcrumb__height p-relative fix" data-background="<?php echo esc_attr($bg_main_img);?>">
         <div class="container">
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content z-index d-flex justify-content-between align-items-end">
                     <div class="breadcrumb__section-title-box">
                        <h4 class="breadcrumb__subtitle"><?php echo esc_html(  $breadcrumb_subtitle_main); ?></h4>
...
function biddut_search_form() {
   ...
   $search_logo_url = get_template_directory_uri() . '/assets/img/logo/white-logo.png';
    $header_search_logo =  get_theme_mod('header_search_logo',$search_logo_url)
               ...
               <div class="search__wrapper">
                  <div class="search__top d-flex justify-content-between align-items-center">
                     <div class="search__logo">
                        <a href="index.html">
                                 <img src="<?php echo esc_url($header_search_logo);?>" alt="<?php echo esc_attr__( 'logo', 'biddut' );?>"
                                 >
                        </a>
                     </div>
                  ...
                  <div class="search__form">
                     <form method="get" action="<?php echo esc_url( home_url( '/' ) );?>" >
                        <div class="search__input">
                           ...
                           type="text" 
                            placeholder="<?php echo esc_attr__( 'Type here to search...', 'biddut' );?>"
                           >
                     ...
                     <div class="search-wrapper">
                        ...
                        <div class="search-content pt-35">
                           ...
                           <div class="d-flex justify-content-center px-5">
                              ...
                              <form method="get" action="<?php echo esc_url( home_url( '/' ) );?>">
                                 <input type="text" name="s" class="search-input" value="<?php echo esc_attr( get_search_query() )?>"  placeholder="<?php echo esc_attr__( 'Search...', 'biddut' );?>">
