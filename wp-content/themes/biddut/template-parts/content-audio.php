...
?>
 ...
 <article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item tp-postbox-item-wrapper mb-80 format-audio' );?>>
...
<?php else: ?>
    ...
    <article id="post-<?php the_ID();?>" <?php post_class( 'postbox__item format-audio mb-30 transition-3' );?>>
