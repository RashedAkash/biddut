 ...
 * @since 1.0.0
 */
class TP_Chose extends Widget_Base {
	...
	protected function register_controls_section() {
        ...
        // imargency section
                $this->start_controls_section(
                    'tp_imargency_section',
                        [
                        'label' => esc_html__( 'imargency', 'tpcore' ),
                ...
                $this->add_control(
                    'tp_imargency_title',
                    [
                        'label' => esc_html__( 'imargency Title', 'tp-core' ),
                ...
                $this->add_control(
                    'tp_imargency_number',
                    [
                        'label' => esc_html__( 'imargency number', 'tp-core' ),
                        'type' => \Elementor\Controls_Manager::TEXT,
                    ]
                );
                //imargency image
...
<?php else: 
    ...
    if ( !empty($settings['tp_shape_image_2']['url']) ) {
     ...
     if ( !empty($settings['tp_imargency_image']['url']) ) {
        $tp_imargency_image = !empty($settings['tp_imargency_image']['id']) ? wp_get_attachment_image_url( $settings['tp_imargency_image']['id'], $settings['bg_image_size_size']) : $settings['tp_imargency_image']['url'];
        $tp_imargency_image_alt = get_post_meta($settings["tp_imargency_image"]["id"], "_wp_attachment_image_alt", true);
    }

    $this->add_render_attribute('title_args', 'class', 'tp-section-title text-white tp-section-title'); 
?>

<!-- process area start -->
<div class="tp-choose-3-area p-relative black-bg-2 pt-120 pb-70 tp-el-section">
    <div class="tp-choose-3-bg"style="background-image: url('<?php echo esc_url( $tp_imargency_image ); ?>');">
    <div class="tp-choose-3-text d-none d-lg-block">
        <span><?php echo tp_kses($settings['tp_imargency_title']); ?></span>
        <a href="tel:<?php echo esc_attr($settings['tp_imargency_number']); ?>"> <?php echo tp_kses($settings['tp_imargency_number']); ?></a>
    </div>
    </div>
    <div class="container">
    <div class="row">
        <div class="col-xl-6 col-lg-6 offset-lg-6 offset-xl-6  wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
            <div class="tp-choose-content tp-choose-item-wrap z-index">
                ...
                <div class="tp-choose-section-box mb-30">
                    <?php if ( !empty($settings['tp_section_sub_title']) ) : ?>
                        <span class="tp-section-subtitle text-color tp-el-sub-title">
                            <?php echo tp_kses( $settings['tp_section_sub_title'] ); ?>
                        </span>
                        <?php endif; ?> 
                ...
                <?php if ( !empty($settings['tp_section_description']) ) : ?>
                <div class="tp-choose-text tp-el-des mb-50">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 mb-20">
                        <div class="tp-choose-item d-flex align-items-center">
                            <span>
                                ...
                                <?php if (!empty($item['tp_process_title'])): ?>
                            <h5 class="tp-choose-item-title tp-el-rep-title"><?php echo tp_kses($item['tp_process_title' ]); ?></h5>
                            <?php endif; ?>
...
$widgets_manager->register( new TP_Chose() );